...
public class CS401BST<E extends Comparable<E>>
{
    ...
    public boolean add_r(E element)
    {
    	if (root == null) 
        ...
        {
        	return add_r(root, element);
        }
    }
    private boolean add_r(TreeNode<E> temp, E element) {
        if (element.compareTo (temp.element) == 0) {
            ...
            if (temp.left == null) {
                ...
                return add_r(temp.left, element);
            }
        }
        else {
            if (temp.right == null) {
                ...
                return add_r(temp.right, element);
            }
        }
    }
